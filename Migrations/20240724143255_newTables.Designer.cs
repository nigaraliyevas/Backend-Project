...
namespace EduHome.Migrations
{
    ...
    [Migration("20240724143255_newTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduHome.Models.Skill", b =>
                {
                    ...
                    b.Property<double>("SkillPercent")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("EduHome.Models.TeacherSM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduHome.Models.TeacherSM", b =>
                {
                    b.HasOne("EduHome.Models.Teacher", null)
                        .WithOne("SM")
                        .HasForeignKey("EduHome.Models.TeacherSM", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
